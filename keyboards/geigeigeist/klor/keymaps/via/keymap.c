...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 /*
   ...
   └─────────┴─────────┴─────────┼─────────┼─────────┼─────────┼╰────────╯╰────────╯┼─────────┼─────────┼─────────┼─────────┴─────────┴─────────┘
                                 │  TAB    │  LOWER  │  SPACE  │   ALT   ││ CMD/WIN │  ENTER  │  RAISE  │ BSPACE  │  
                                 └─────────┴─────────┴─────────┴─────────┘└─────────┴─────────┴─────────┴─────────┘ */ 

//   [_QWERTY] = LAYOUT_polydactyl(
// //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
//              KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,                          KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,  
//    KC_TAB,   GUI_A,   ALT_S,    CTL_D,    SHT_F,     KC_G,                          KC_H,    SHT_J,    CTL_K,    ALT_L,  GUI_SCLN,  KC_QUOT,
//    KC_DEL,   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,    KC_MUTE,   KC_MPLY,   KC_N,     KC_M,  KC_COMM,   KC_DOT,   KC_SLSH,  KC_RSFT,
//                                  KC_TAB,  LOWER,    KC_SPC,   KC_LALT,   KC_LGUI,   KC_ENT,   RAISE,    KC_BSPC
// ),
...
//    KC_TAB,   KC_A,    ALT_R,    CTL_S,    SHT_T,    KC_D,                          KC_H,     SHT_N,    CTL_E,    ALT_I,    GUI_O,    KC_QUOT,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [_COLEMAK] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU),           ENCODER_CCW_CW(KC_WH_D, KC_WH_U)  },
    [_NUM] =     { ENCODER_CCW_CW(KC_VOLD, KC_VOLU),           ENCODER_CCW_CW(KC_WH_D, KC_WH_U)  },
    [_FUNC] =    { ENCODER_CCW_CW(KC_VOLD, KC_VOLU),           ENCODER_CCW_CW(KC_WH_D, KC_WH_U)  },
    [_NAV] =     { ENCODER_CCW_CW(RGB_HUD, RGB_HUI),           ENCODER_CCW_CW(KC_MPRV, KC_MNXT)  },
    [_SYS] =     { ENCODER_CCW_CW(KC_VOLD, KC_VOLU),           ENCODER_CCW_CW(KC_WH_D, KC_WH_U)  },
};
#endif
